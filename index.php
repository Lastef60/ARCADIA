...
<body id="js_index_page">
  ...
  <div class="css_index_habitat">
    ...
    <img class="css_index_img_habitat flash js_habitat" src="./uploads/img/jungle_habitat.jpg" />

    <img class="css_index_img_habitat flash js_habitat" src="./uploads/img/savane_habitat.jpg" />

    <img class="css_index_img_habitat flash js_habitat" src="./uploads/img/marais_habitat.jpg" />
  </div>
  ...
  <div class="css_galerie">
    <img class="js_services" src="./uploads/img/service_petitTrain.jpg" />
    <img class="js_services" src="./uploads/img/service_resto1.jpg" />
    <img class="js_services" src="./uploads/img/service_resto2.jpg" />
    <img class="js_services" src="./uploads/img/service_resto3.jpg" />
    <img class="js_services" src="./uploads/img/service_visiteGuidee.jpg" />
  </div>
  <h2>Ils sont venus nous voir ...</h2>

  <div class="container">
    <div class="carrousel">
      <div class="carrousel_diapo">
        <?php
        if ($avisVisiteurs) {
          foreach ($avisVisiteurs as $avisVisiteur) {
            echo '<div class="diapo">'; // Div pour chaque diapositive
