...
require_once(__DIR__ . '/../src/classes/RapportVeterinaireManager.php');

// Connexion à la base de données
$database = new Database();
$pdo = $database->getConnection();

// Création d'une instance du gestionnaire de rapports
$rapportManager = new RapportVeterinaireManager($pdo);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Appeler la méthode pour ajouter le rapport vétérinaire
    try {
        $rapportManager->ajouterRapport($date, $detail, $etatanimal, $nourriture, $grammage, $nomanimal);
        $success = true;
    } catch (Exception $e) {
